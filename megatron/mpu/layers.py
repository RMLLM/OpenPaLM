...
from ..model.normalizations import NORMALIZATIONS
...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim,
        ...
        if mpu.is_pipeline_first_stage() and (args.use_bnb_optimizer or args.embed_norm):
            self.norm = NORMALIZATIONS[args.normalization](embedding_dim, eps=args.norm_epsilon)
